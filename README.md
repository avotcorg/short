...
*Demo* : [https://dz.qqqqqq.tk/](https://dz.qqqqqq.tk/)
...
```bash
# POST /create
curl -X POST -H "Content-Type: application/json" -d '{"url":"https://dz.qqqqqq.tk"}' https://dz.qqqqqq.tk/create

# 指定slug
curl -X POST -H "Content-Type: application/json" -d '{"url":"https://dz.qqqqqq.tk","slug":"scxs"}' https://dz.qqqqqq.tk/create
